...
- `sidebar` config for navigation links configuration
    ...
    - `frontLine` - whether to show a front line at the beginning of a nested menu.(Collapsing capability would be turned off if this option is set to true)
...
To set up Algolia, go to `config.js` and update the `search` object to look like the one below:
